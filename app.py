...
with tab1:
    ...
    with st.form("predictionform"):
        ...
        with col1:
            prog_label = st.select_slider(
                "Programming Skill",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
            )
            prob_label = st.select_slider(
                "Problem Solving",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
            )
        ...
        with col2:
            comm_label = st.select_slider(
                "Communication Skill",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
            )
            lead_label = st.select_slider(
                "Leadership",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
            )
            exp = st.selectbox("Experience (Years)", [0, 1, 2, 3, 4, 5])
...
with tab2:
    ...
    for i in range(team_size):
        ...
        col1, col2 = st.columns(2)
        with col1:
            programming_label = st.select_slider(
                "Programming Skill",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
                key=f"prog_{i}",
            )
        ...
        with col2:
            communication_label = st.select_slider(
                "Communication Skill",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
                key=f"comm_{i}",
            )
        ...
        with col3:
            problem_label = st.select_slider(
                "Problem Solving",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
                key=f"prob_{i}",
            )
        ...
        with col4:
            leadership_label = st.select_slider(
                "Leadership",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
                key=f"lead_{i}",
            )
        ...
        with col5:
            experience = st.selectbox("Experience (Years)", [0, 1, 2, 3, 4, 5], key=f"exp_{i}")
        with col6:
            tech_label = st.select_slider(
                "Technical Depth",
                ["Very Low", "Low", "Medium", "Good", "Excellent"],
